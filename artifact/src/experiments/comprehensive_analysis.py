...
from ..analysis.acm_sensitivity import ACMKeySensitivityAnalyzer
from ..analysis.permutation_sensitivity import PermutationSensitivityAnalyzer
from ..analysis.dual_encryption_analysis import DualEncryptionAnalyzer
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help='Path to CIFAR-100 dataset (overrides config)'
    )
    parser.add_argument(
